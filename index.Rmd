...
Desta forma, o público alvo é aquele que tem conhecimento <p/ style="color:red">zero</p> sobre o assunto. Mas se você já sabe algo em qualquer nível, seja bem vindo também e podemos aprender juntos, você ensina o que você sabe e eu ensino o que eu sei.
...
Muitas vezes surgem perguntas como:<p style="color:red">"Tem como fazer isso no R?"</p> A resposta imediada, devido à sua versatilidade, é: <p style="color:blue">"A pergunta não é "se tem jeito", mas "como fazer".</p>
