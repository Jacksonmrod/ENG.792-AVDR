...
O conteúdo apresentado aqui não será apresentado corretamente no material online. Para saber o real *output* veja o arquivo gerado em *.pdf*.
...
## Variando Cores
\normalsize
\textcolor{red}{vermelho}, \textcolor{blue}{azul}, \textcolor{purple}{roxo}.
