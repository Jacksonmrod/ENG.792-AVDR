...
Assista este conteúdo em **Cap 4 - Produção gráfica e comunicação visual - Parte 1** no [PVANet](https://www2.cead.ufv.br/sistemas/pvanet/geral/login.php)
...
No `boxplot` cada caixa mostra os dados observados de cada tipos de _spray_ (A até F) e vemos que os inseticidas C, D e E são os mais eficientes.  
...
* Se _x_ é um _factor_ e _y_ um vetor numérico `plot(x,y)` produzirá um _boxplot_ de _y_ para cada nível de _x_.
...
![](J:/ENG 792/ENG_792-AVDR/ENG.792-AVDR/Cap_4_linetypes-in-r-line-types.JPG)
...
![Margens da figura](J:/ENG 792/ENG_792-AVDR/ENG.792-AVDR/Cap_4_PlotRegion1.png)
Fonte: [http://applied-r.com/](http://applied-r.com/wp-content/uploads/2013/10/PlotRegion1.png)
...
![](J:/ENG 792/ENG_792-AVDR/ENG.792-AVDR/Cap_4_tidyverse.JPG)
