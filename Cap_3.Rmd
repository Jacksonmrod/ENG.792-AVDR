...
No entanto, uma dúvida que por ventura você tenha e não consida sanar dentro das opções de ajuda do próprio R, buscar em fóruns sobre o assunto pode ser uma saída, pois geralmente a sua dúvida foi a dúvida de alguém antes de você.
...
Podemos imaginar a função dividida em 3 partes (entrada, processamento e sapida) como uma caixa com muito buracos de uma lado ( _inputs_) e apenas um buraco do outro ( _output_) e a caixa atua de acordo com nossos comandos. Ou ainda como processamento de frutas para um suco.
...
No caso a seguir, o comando `Matrícula=numeric(0)` cria uma variável de um `mode()`específico, mas sem dados. O comando `edit()`, por sua vez, e como nome sugere, permite editar um banco de dados. Um _popup_ abrirá na sua tela que permitirá a sua edição. Após o uso bas fechar que as edições feitas serão salvas.  

![**comando edit()**](J:/ENG 792/ENG_792-AVDR/ENG.792-AVDR/Cap_3_edit DF.JPG){#id .class width=35% height=35%} 
...
Baixe os dados aqui [Notas.txt](https://drive.google.com/file/d/1k73dMfJF3Dj7vOqfOX6F3W2_jRrP9ix_/view?usp=sharing)
...
![**Notas Eng792**](J:/ENG 792/ENG_792-AVDR/ENG.792-AVDR/Cap_3_notas eng 792.jpg){#id .class width=50% height=50%}
...
Experimente ambos comandos para abrir o _Notas_ENG792.csv_.  
![**Notas_,_.csvCap_3_notas.csv eng 792.jpg:/ENG 792/ENG_792-AVDR/ENG.792-AVDR/Cap_3){#id .class width=50% height=50%} 
...
![**Informações Alunos - ENG 792.xlsx**](J:/ENG 792/ENG_792-AVDR/ENG.792-AVDR/Cap_3_InformaÃ§Ãµes - Alunos ENG 792.jpg){#id .class width=100% height=100%}
...
Reposição.de.aula<-read.xlsx(file="Cap_3_Informações - Alunos ENG 792.xlsx", endRow=28,sheetIndex=4,startRow = 2, header =T, encoding="UTF-8")
...
13. Demonstre como mostrar o número de linhas do new_frame.
