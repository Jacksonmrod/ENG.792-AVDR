...
Temos 1 arquivo [Cap_1_P2-Mispriced-Diamonds.csv](https://github.com/Jacksonmrod/ENG.792-AVDR/blob/master/Cap_1_P2-Mispriced-Diamonds.csv) com mais de 50.000 linhas referentes a transações de venda de diamantes dividida em 3 colunas *clarity*, *carat* e *price*. Quanto mais claro mais caro, certo? Ou há sub ou super valorização? Vamos investigar se essa relação é verdadeira.
